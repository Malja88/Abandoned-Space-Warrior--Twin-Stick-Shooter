...
public partial class SpeedBoostSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        Entities
            .WithoutBurst()
            .ForEach((Entity entity, SpeedBoostTag tag, ref DynamicBuffer<StatefulTriggerEvent> triggerEventBuffer) =>
            {
                ...
                for (int i = 0; i < triggerEventBuffer.Length; i++)
                {
                    ...
                    if (triggerEvent.State == StatefulEventState.Enter && tag.SpeedBoostAction is IBonusAbility ability)
                    {
                       ability.Collect();
